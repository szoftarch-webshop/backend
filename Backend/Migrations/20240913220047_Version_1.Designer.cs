...
namespace Backend.Migrations
{
    ...
    [Migration("20240913220047_Version_1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Dal.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Backend.Dal.Entities.ShippingAddress", "ShippingAddress")
                        .WithOne("Order")
                        .HasForeignKey("Backend.Dal.Entities.Order", "ShippingAddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CategoryProduct", b =>
                {
                    b.HasOne("Backend.Dal.Entities.Category", null)
                        .WithMany()
